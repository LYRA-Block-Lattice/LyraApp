    ...
    public class NFTStorageClient : WebApiClientBase
    {
        ...
        */
        public async Task<NFTStorageListFilesResponse> ListFiles(string before = null, int limit = 10)
        {
            ...
            NFTStorageListFilesResponse parsedResponse = JsonConvert.DeserializeObject<NFTStorageListFilesResponse>(rawResponse);
        ...
        */
        public async Task<NFTStorageGetFileResponse> GetFile(string cid)
        {
            ...
            string rawResponse = await SendHttpRequest(HttpMethod.Get, requestUri);
            NFTStorageGetFileResponse parsedResponse = JsonConvert.DeserializeObject<NFTStorageGetFileResponse>(rawResponse);
            return parsedResponse;
        }
        ...
        */
        public async Task<NFTStorageCheckResponse> CheckFile(string cid)
        {
            ...
            string rawResponse = await SendHttpRequest(HttpMethod.Get, requestUri);
            NFTStorageCheckResponse parsedResponse = JsonConvert.DeserializeObject<NFTStorageCheckResponse>(rawResponse);
            return parsedResponse;
        }
        ...
        */
        public async Task<NFTStorageDeleteResponse> DeleteFile(string cid)
        {
            ...
            NFTStorageDeleteResponse parsedResponse = JsonConvert.DeserializeObject<NFTStorageDeleteResponse>(rawResponse);
            return parsedResponse;
        }
