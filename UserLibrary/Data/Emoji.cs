...
namespace UserLibrary.Data
{
    public class Emoji
    {
        public static List<string> MostCommonCollection = new()
        {
            Grin, Joy, Smiley, Smile, Sweat_Smile, Laughing,
            Wink, Blush, Yum, Relieved, Heart_Eyes, Smirk,
            Unamused, Sweat, Pensive, Confounded, Kissing_Heart,
            Kissing_Closed_Eyes, Stuck_Out_Tongue_Closed_Eyes,
            Stuck_Out_Tongue_Winking_Eye, Disappointed, Angry,
            Rage, Cry, Persevere, Triumph, Disappointed_Relieved,
            Fearful, Sleepy, Tired_Face, Sob, Cold_Sweat, Scream,
            Astonished, Flushed, Dizzy_Face, Mask,
        };
