...
function SearchTokenInput({ dir, cat, ownOnly, onTokenSelect, val }) {
  ...
  async function getTokens() {
    let str =
      await window.rrProxy.ReactRazor.Pages.Home.Interop.GetBalancesAsync(
        window.rrComponent
      );
  ...
  const searchToken = (searchTerm, cat) => {
    if (ownOnly && cat != "Fiat") {
      ...
      window.rrProxy.ReactRazor.Pages.Home.Interop.SearchTokenForAccountAsync(
        window.rrComponent,
        searchTerm,
        cat
      )
      ...
      window.rrProxy.ReactRazor.Pages.Home.Interop.SearchTokenAsync(
        window.rrComponent,
        searchTerm,
        cat
      )
