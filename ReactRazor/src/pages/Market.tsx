    ...
    <div className="market">
      <div className="bannersection">
        ...
        <div className="illuscard-3-copy1">
          ...
          />
          <img className="group-icon" alt="" src="_content/ReactRazor/asserts/group1.svg" />
          <div className="wallet-no">NFT</div>
          <div className="div">2</div>
          <div className="div1">5,000 LYR</div>
          <div className="usd-wallet">My Secondary Account</div>
          <div className="rectangle1" />
          <div className="rectangle2" />
          <div className="cen-wallet-copy">
            <span className="lyra-walle">Lyra walle</span>t
